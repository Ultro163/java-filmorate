...
public class FilmDbServiceImpl implements FilmService {
    ...
    public FilmDbServiceImpl(@Qualifier("FilmDbStorage") FilmStorage filmStorage, @Qualifier("UserDbServiceImpl") UserService userService) {
